                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody class="actionbtn">
                                        <?php
                                            ...
                                            ?>
                                            <tr>
                                                <td id ='no'><?php echo $rowNumber; ?></td>
                                                <td id='p_name'><?php echo $projectName; ?></td>
                                                <td id ='projectAbstract'><?php echo $projectAbstract; ?></td>
                                                <td id = 'techonlogy'><?php echo $projectTechnology; ?></td>
                                                <td id = 'no_of_members'><?php echo $projectMembers; ?></td>
                                                <td id = 'status'><?php echo $projectStatus; ?></td>
                                                <td id='duration'><?php echo $projectDuration; ?></td>
