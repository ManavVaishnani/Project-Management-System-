    ...
    <div class="container">
        <div class="card border-primary">
            <div class="card-body">
                ...
                <form method="POST" action="javascript:void(0)" id="passwordForm" class="needs-validation" novalidate>
                <div class="form-group">
                        <label for="currentPassword">Current Password:</label>
                        <input type="password" class="form-control" id="currentPassword" name="currentPassword" placeholder="Enter new password" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="error"><p class="msg"></p></div>
                    </div>
